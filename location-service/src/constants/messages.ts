export const MESSAGES = {
    ...
    DISTRICT_EXISTS: "District aleary exists",
    ...
    SERVICE_AREA_EXISTS: "Service area aleary exists",
    ...
    DISTRICTS_WITH_SERVICE_AREAS_FETCHED: "Districts with service areas fetched",
